...
pub async fn page_news(req: HttpRequest, arg: web::Query<NewsPageDTO>) -> impl Responder {
    ...
    let vo = CONTEXT
        .content_service
        .news_page(&req, None, &arg.into_inner())
        .await;
    return RespVO::from_result(&vo).resp_json();
}
...
pub async fn notebook_list(req: HttpRequest, arg: web::Query<NoteBookDTO>) -> impl Responder {
    ...
    let vo = CONTEXT
        .content_service
        .list_notebook(&req, None, &arg.into_inner())
        .await;
    return RespVO::from_result(&vo).resp_json();
}
...
pub async fn page_notes(req: HttpRequest, arg: web::Query<NotesPageDTO>) -> impl Responder {
    ...
    let vo = CONTEXT
        .content_service
        .page_notes(&req, None, &arg.into_inner())
        .await;
    return RespVO::from_result(&vo).resp_json();
}
...
/// 统计近6个月的动态发布情况
#[get("/news/total/pre6")]
pub async fn compute_pre6_news(
    req: HttpRequest,
    ...
    let vo = CONTEXT
        .content_service
        .compute_pre6_news(&req, &arg.archive_date.clone())
        .await;
    return RespVO::from_result(&vo).resp_json();
}
...
/// 获取动态分页列表[公众]
#[get("/page/news/{id}")]
pub async fn public_page_news(
    req: HttpRequest,
    path: web::Path<u64>,
    arg: web::Query<NewsPageDTO>,
) -> impl Responder {
    log::info!("page_news:{:?}", arg.clone().into_inner());
    let organize = path.into_inner();
    let vo = CONTEXT
        .content_service
        .news_page(&req, Some(organize), &arg.into_inner())
        .await;
    return RespVO::from_result(&vo).resp_json();
}
...
/// 获取笔记分页列表[公众]
#[get("/page/notes/{id}")]
pub async fn public_page_notes(
    req: HttpRequest,
    path: web::Path<u64>,
    arg: web::Query<NotesPageDTO>,
) -> impl Responder {
    log::info!("page_notes:{:?}", arg.clone().into_inner());
    let organize = path.into_inner();
    ...
    let vo = CONTEXT
        .content_service
        .page_notes(&req, Some(organize), &param)
        .await;
    return RespVO::from_result(&vo).resp_json();
}
...
/// 获取笔记簿列表[公众]
#[get("/notebook/{id}")]
pub async fn public_notebook_list(
    req: HttpRequest,
    path: web::Path<u64>,
    arg: web::Query<NoteBookDTO>,
) -> impl Responder {
    log::info!("notebook_list:{:?}", arg.clone().into_inner());
    let organize = path.into_inner();
    let mut param = arg.into_inner().clone();
    ...
    let vo = CONTEXT
        .content_service
        .list_notebook(&req, Some(organize), &param)
        .await;
    return RespVO::from_result(&vo).resp_json();
}
...
pub async fn public_news_detail(path: web::Path<(u64, u64)>) -> impl Responder {
    ...
    let vo = CONTEXT
        .content_service
        .public_news_detail(&organize, &id)
        .await;
    return RespVO::from_result(&vo).resp_json();
}
...
pub async fn public_notes_detail(path: web::Path<(u64, u64)>) -> impl Responder {
    ...
    let vo = CONTEXT
        .content_service
        .public_notes_detail(&organize, &id)
        .await;
    return RespVO::from_result(&vo).resp_json();
}
